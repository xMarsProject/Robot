...
#define timeSleep 40 // nombre de milliseconde entre chaque passe de mesure
...
#define REG3 2 // Registre 3 (8 bits) IR gauche2
#define REG4 3 // Registre 4 (8 bits) IR milieu
#define REG5 4 // Registre 5 (8 bits) IR droit1
#define REG6 5 // Registre 6 (8 bits) IR droit2
